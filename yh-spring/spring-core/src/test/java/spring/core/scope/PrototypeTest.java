...
public class PrototypeTest {
    ...
    void prototypeBeanFind(){
        ...
        assertThat(prototypeBean1).isNotSameAs(prototypeBean2); //싱글톤과 다르게 다른 객체를 돌려준다
        ac.close(); //종료
    }
 ...
 * find prototypeBean2
 * PrototypeBean.init
 * prototypeBean1 = spring.core.scope.PrototypeTest$PrototypeBean@30f842ca
 * prototypeBean2 = spring.core.scope.PrototypeTest$PrototypeBean@69c81773
 *
 ...
 *
 * 그래서 @PreDestroy 같은 종료 메서드가 호출되지 않는다. (이게 중요!!!)
 */
